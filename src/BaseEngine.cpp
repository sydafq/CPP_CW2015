...
int BaseEngine::InitialiseObjects()
{
	...
	//CreateObjectArray();
	//m_ppDisplayableObjects.assign(1,NULL);																												//Draft
...
void BaseEngine::CreateObjectArray(int iNumberObjects)
{
	...
	DestroyOldObjects();
	//m_ppDisplayableObjects.clear();																													//Draft
	...
	m_ppDisplayableObjects.assign(iNumberObjects + 1, nullptr);
}
...
void BaseEngine::DestroyOldObjects()
{
	...
	//	{
	//		//delete m_ppDisplayableObjects[i];
	//		m_ppDisplayableObjects.erase(m_ppDisplayableObjects.begin()+i);
	//		//m_ppDisplayableObjects[i] = NULL;
	//		m_ppDisplayableObjects.assign(i,NULL);
	//	}
	//	
	//}
...
void BaseEngine::UpdateAllObjects(int iCurrentTime)
{
	...
	int i = 0;
	if (!m_ppDisplayableObjects.empty()) {
		// iterate while i != null and within size of vector container
		while (i < m_ppDisplayableObjects.size() && m_ppDisplayableObjects[i] != NULL) {
...
void BaseEngine::DrawObjects()
{
	...
	int i = 0;
	// STL contains objects
	if (!m_ppDisplayableObjects.empty()) {

		while (m_ppDisplayableObjects[i] != NULL && i < m_ppDisplayableObjects.size()) {
